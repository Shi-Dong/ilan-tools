...
class Client:
    ...
    def get_history_url(self, name: str) -> dict: return self.get(f"/tasks/{name}/history-url")
    ...
    def set_notes(self, name: str, notes: str) -> dict:
        return self.post(f"/tasks/{name}/notes", {"notes": notes})
