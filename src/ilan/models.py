...
# state it is; ``dim green`` is taken by DONE. Bold because a cycling task always
# renders on the reply-every grey background, against which dark_green on its own
# is barely legible.
