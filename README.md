...
| `ilan latest [-n N]` | List the tasks most recently marked done, newest first, one plain line per task: its number, its name, and its note. `-n` sets how many to show (default 10). |
