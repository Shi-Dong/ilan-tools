...
| `ilan btw NAME "question"` | Create `xxx-<parent-name>-btw` from a task name or alias, with instructions to focus on the new request and leave earlier work and running jobs to the parent. Same options as `branch`; `-n` overrides the name. |
