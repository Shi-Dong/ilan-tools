...
| `ilan notes NAME ["note"] [-a TEXT] [-c]` | `ilan task notes NAME ["note"] [-a TEXT] [-c]` |
| `ilan note NAME ["note"] [-a TEXT] [-c]` | `ilan task notes NAME ["note"] [-a TEXT] [-c]` |
